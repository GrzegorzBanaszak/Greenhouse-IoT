...
Kompletny projekt sterowania podlewaniem szklarni. Składa się z firmware dla ESP32 oraz aplikacji mobilnej Ionic + Capacitor.
...
- Ionic React, TypeScript i Capacitor dla aplikacji mobilnej
- Serwisy HTTP i mock/dev Wi-Fi scanner
...
## Uruchomienie aplikacji Ionic + Capacitor

Wymagane: Node.js, npm oraz Android Studio dla buildów Android przez Capacitor.
...
- Android ogranicza automatyczne łączenie z Wi-Fi; aplikacja Ionic ma fallback mock/dev, a docelowa natywna obsługa Wi-Fi powinna zostać dodana przez Capacitor.
...
- Dodać testy jednostkowe dla serwisów Ionic/TypeScript oraz testy integracyjne API ESP32.
